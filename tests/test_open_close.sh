...
{ 
	...
	${TEST_RUNNER} ./${PFF_TEST_OPEN_CLOSE} ${INPUT_FILE};
...
PFF_TEST_OPEN_CLOSE="pff_test_open_close";

if ! test -x ${PFF_TEST_OPEN_CLOSE};
then
	PFF_TEST_OPEN_CLOSE="pff_test_open_close.exe";
fi

if ! test -x ${PFF_TEST_OPEN_CLOSE};
then
	echo "Missing executable: ${PFF_TEST_OPEN_CLOSE}";
