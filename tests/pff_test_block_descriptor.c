...
/* Tests the libpff_block_descriptor_initialize function
 * Returns 1 if successful or 0 if not
 */
int pff_test_block_descriptor_initialize(
     void )
{
	...
	block_descriptor = (libpff_block_descriptor_t *) 0x12345678UL;
	...
	for( test_number = 0;
	     ...
	     test_number++ )
	{
		/* Test libpff_block_descriptor_initialize with malloc failing
		 */
	...
	for( test_number = 0;
	     ...
	     test_number++ )
	{
		/* Test libpff_block_descriptor_initialize with memset failing
		 */
...
/* Tests the libpff_block_descriptor_free function
 * Returns 1 if successful or 0 if not
 */
int pff_test_block_descriptor_free(
     void )
{
	libcerror_error_t *error = NULL;
	int result               = 0;
...
#endif
{
	...
	PFF_TEST_RUN(
	 "libpff_block_descriptor_initialize",
	 pff_test_block_descriptor_initialize );

	PFF_TEST_RUN(
	 "libpff_block_descriptor_free",
	 pff_test_block_descriptor_free );
