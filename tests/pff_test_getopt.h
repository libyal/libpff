...
#if !defined( _PFF_TEST_GETOPT_H )
#define _PFF_TEST_GETOPT_H
...
#define pff_test_getopt( argument_count, argument_values, options_string ) \
...
system_integer_t pff_test_getopt(
                  int argument_count,
...
#endif /* !defined( _PFF_TEST_GETOPT_H ) */
