     ...
     libcerror_error_t **error )
{
	...
	*file_object_io_handle = (pypff_file_object_io_handle_t *) PyMem_Malloc(
	                                                            sizeof( pypff_file_object_io_handle_t ) );
     ...
     libcerror_error_t **error )
{
	...
	if( pypff_integer_signed_copy_to_64bit(
	     method_result,
	     offset,
	     error ) != 1 )
	{
     ...
     libcerror_error_t **error )
{
	...
	if( pypff_integer_unsigned_copy_to_64bit(
	     method_result,
	     size,
	     error ) != 1 )
	{
