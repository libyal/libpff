...
#include "pypff_file_content_types.h"
#include "pypff_libpff.h"
#include "pypff_python.h"
#include "pypff_unused.h"

PyTypeObject pypff_file_content_types_type_object = {
	PyVarObject_HEAD_INIT( NULL, 0 )

	/* tp_name */
	"pypff.file_content_types",
	/* tp_basicsize */
	sizeof( pypff_file_content_types_t ),
	/* tp_itemsize */
	0,
	/* tp_dealloc */
	(destructor) pypff_file_content_types_free,
	/* tp_print */
	0,
	/* tp_getattr */
	0,
	...
	Py_TPFLAGS_DEFAULT,
	/* tp_doc */
	"pypff file content types object (wraps LIBPFF_FILE_CONTENT_TYPES)",
	/* tp_traverse */
	0,
	/* tp_clear */
	0,
	...
	0,
	/* tp_init */
	(initproc) pypff_file_content_types_init,
	/* tp_alloc */
	0,
	/* tp_new */
	0,
...
/* Creates a new file content types object
