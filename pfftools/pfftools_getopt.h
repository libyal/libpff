...
#if !defined( _PFFTOOLS_GETOPT_H )
#define _PFFTOOLS_GETOPT_H
...
typedef struct pfftools_option pfftools_option_t;

struct pfftools_option
{
...
#define pfftools_getopt( argument_count, argument_values, options_string ) \
...
system_integer_t pfftools_getopt(
                  int argument_count,
...
void pfftools_getopt_wrapped_fprint(
      FILE *stream,
...
void pfftools_getopt_usage_fprint(
      FILE *stream,
      const char *program,
      const char *description,
      const pfftools_option_t *options,
      int number_of_options );

int pfftools_getopt_get_options_string(
     const pfftools_option_t *options,
     int number_of_options,
...
#endif /* !defined( _PFFTOOLS_GETOPT_H ) */
