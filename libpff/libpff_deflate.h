...
#if !defined( _LIBPFF_DEFLATE_COMPRESSION_H )
#define _LIBPFF_DEFLATE_COMPRESSION_H
...
/* The block types
 */
enum LIBPFF_DEFLATE_BLOCK_TYPES
{
	LIBPFF_DEFLATE_BLOCK_TYPE_UNCOMPRESSED		= 0x00,
	LIBPFF_DEFLATE_BLOCK_TYPE_HUFFMAN_FIXED		= 0x01,
	LIBPFF_DEFLATE_BLOCK_TYPE_HUFFMAN_DYNAMIC	= 0x02,
	LIBPFF_DEFLATE_BLOCK_TYPE_RESERVED		= 0x03
};

typedef struct libpff_deflate_bit_stream libpff_deflate_bit_stream_t;

struct libpff_deflate_bit_stream
{
	/* The byte stream
	 */
...
typedef struct libpff_deflate_huffman_table libpff_deflate_huffman_table_t;

struct libpff_deflate_huffman_table
{
